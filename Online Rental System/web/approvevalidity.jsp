...
<% 
    ...
    final String msg="This mail is to inform that your request for extention of time period for "+extend+" for asset "+assetname+" is approved by the owner"; 
    ...
    Properties props = new Properties();    
          ...
          try {    
           ...
           message.setSubject("Approve Validity Extension");    
           message.setContent(msg,"text/html");
           Transport.send(message);    
           System.out.println("message sent successfully");    
          } catch (MessagingException e) {throw new RuntimeException(e);}  

          PreparedStatement ps4 = con.prepareStatement("delete from validityextension where username=?");
