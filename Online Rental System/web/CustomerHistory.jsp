                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                                    ...
                                                    while (rs.next()) {
                                                       ...
                                                       String fname="",lname="",mobile="";
                                                        PreparedStatement ps=con.prepareStatement("Select * from addhouse where id=?");
                                                         ...
                                                         PreparedStatement ps2=con.prepareStatement("Select * from clientregister where username=?");
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="CustomerDetail1.jsp?mob=<%=mobile%>"><input type="submit" class="fadeIn fourth" value="View"></a></td>
