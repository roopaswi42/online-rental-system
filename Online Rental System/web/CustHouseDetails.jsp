                ...
                <div id="content-wrapper" class="d-flex flex-column" style="background: url(img/i2.jpg) no-repeat center center fixed; background-size: cover; -o-background-size: cover; -moz-background-size: cover; -webkit-background-size: cover;">
                    ...
                    <div id="content">
                        ...
                        <%                try {
                                ...
                                PreparedStatement ps=con.prepareStatement("Select id from housedetails where username=?");
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            ...
                                                            <div class="tab-content ml-1" id="myTabContent">
                                                                <div class="tab-pane fade show active" id="basicInfo" role="tabpanel" aria-labelledby="basicInfo-tab">
                                                                    <div class="row">
                                                                        <div class="col-sm-3 col-md-2 col-5">
                                                                            <label style="font-weight:bold; color: white;">House Name</label>
                                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-3 col-md-2 col-5">
                                                                        <label style="font-weight:bold; color: white;">Category</label>
                                                                    </div>
                                                                    <div class="col-md-8 col-6">
                                                                        <%=rs.getString(2)%>
                                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-3 col-md-2 col-5">
                                                                        <label style="font-weight:bold; color: white;">Bedroom</label>
                                                                    </div>
                                                                    <div class="col-md-8 col-6">
                                                                        <%=rs.getString(3)%>
                                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-3 col-md-2 col-5">
                                                                        <label style="font-weight:bold; color: white;">Price</label>
                                                                    </div>
                                                                    <div class="col-md-8 col-6">
                                                                        <%=rs.getString(11)%>
                                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-3 col-md-2 col-5">
                                                                        <a href="vacate.jsp?id=<%=id1%>"><input type="submit" class="fadeIn fourth" value="Vacate"></a>
                                                                    </div>
                                                                <hr />
                                                            </div>
                                                                                                                    </div>
