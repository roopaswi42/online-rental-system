                     ...
                     <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Approving transaction</h6>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            <%
                                                try {
                                                    ...
                                                    String sql = "select * from approvetransaction ";
                                                    ...
                                                    while (rs.next()) {%>
                                                      <tr>         
                                                        ...
                                                        <td><a href="approvetransaction1.jsp"><input type="submit" class="fadeIn fourth" value="Approve"></a></td>
                                                       </tr>
                                                   <% }
                                                 } catch (Exception e) {
                                                    e.printStackTrace();
