...
<html lang="en">
    ...
    <head>
        ...
        <title>Approve Vacating Houses</title>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Vacating Houses</h6>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            <%
                                                try {
                                                    ...
                                                    String sql = "select * from vacate ";
                                                    ResultSet rs = st.executeQuery(sql);
                                                    int i=1;
                                                    while (rs.next()) {
                                                        String uname = rs.getString(2);
                                                        int hid = rs.getInt(1);
                                                        PreparedStatement ps = con.prepareStatement("select * from userregister where username=?");
                                                        //String sql1="select * from userregister where username="+uname;
                                               ...
                                               <tr>         
                                                ...
                                                <td><%=rs1.getString(5)%></td>
                                                       <% }PreparedStatement ps1 = con.prepareStatement("select * from addhouse where id=?");
                                                        //String sql2="select * from addhouse where id="+hid;
                                                        ps1.setInt(1, hid);
                                            ...
                                            %>
                                                ...
                                                <td><%=rs2.getString(11)%>&nbsp;RS</td>
                                                <td><a href="vacatehouse.jsp?hid=<%=hid%>"><input type="submit" class="fadeIn fourth" value="Approve"></a></td>
                                                <td><a href="vacatehouse1.jsp?hid=<%=hid%>"><input type="submit" class="fadeIn fourth" value="Disapprove"></a></td>
                                            </tr>
                                            <%
                                                    }
                                                    }   
