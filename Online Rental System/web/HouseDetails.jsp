        ...
        <nav class="navbar navbar-expand-sm navbar-light" style="background-color: #e3f2fd;">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav ml-auto" style="margin-right: 20px;">
                    <a class="nav-item nav-link active" href="Home.jsp">Dashboard</a>
                    <a class="nav-item nav-link active" href="ClientAddHouse.jsp">Add House</a>
                    <a class="nav-item nav-link active" href="approveextension.jsp">Approve Extention</a> 
                    <a class="nav-item nav-link active" href="CustomerHistory.jsp">History of Customer</a> 
                    <a class="nav-item nav-link active" href="ApproveTransaction.jsp">Approve Transaction</a> 
