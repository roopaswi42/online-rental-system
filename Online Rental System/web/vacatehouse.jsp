...
<% 
    ...
    PreparedStatement ps1 = con.prepareStatement("update addhouse set occupency=1 where id=?");
    ps1.setInt(1,id1);
    ...
    final String msg="This mail is to inform that admin had accepted your request for vacating house"; 
    ...
    Properties props = new Properties();    
          ...
          PreparedStatement ps2 = con.prepareStatement("delete from housedetails where id=?");
          ps2.setInt(1,id1);
