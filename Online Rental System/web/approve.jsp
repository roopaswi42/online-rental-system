                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Renting Houses</h6>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            %>
                                                ...
                                                <td><a href="approvehouse.jsp?hid=<%=hid%>"><input type="submit" class="fadeIn fourth" value="Approve"></a></td>
                                                <td><a href="disapprovehouse.jsp?hid=<%=hid%>"><input type="submit" class="fadeIn fourth" value="Disapprove"></a></td>
                                            </tr>
                                            <%
                                                    }
                                                    }   
