    ...
    <body id="page-top">
                ...
                <div id="content">
                    ...
                    <section class="card-columns">
                        <%                try {
                                ...
                                if (query != null) {
                                    sql = "select * from addhouse where occupency=1 city like '%" + query + "%' or price like '%" + query + "%' or bedroom like '%" + query + "%' ";
                                } else {
                                    sql = "select * from addhouse where occupency=1";
                                }
                        ...
                        <div class="card" style="width: 350px;; margin-left: 40px; margin-right: 40px; margin-top: 50px;">
                            ...
                            <div class="card-body">
                               ...
                               <a href="addcart.jsp?hid=<%=hid%>"> <i class="fas fa-cart-plus fa-2x"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
        ...
        PreparedStatement ps = con.prepareStatement("insert into approve(id,username) values(?,?)");
            ...
            if (i > 0) {
                ...
                window.location.href = "SearchHouse.jsp";
            } else {
